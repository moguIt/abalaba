                                    ...
                                    <ul class="nav nav-pills">
                                        <li>
                                            <a href="#"><i class="fa fa-phone"></i>
                                                +38 050 959 47 27<a href="#" class="work-time">8:00 - 16:00</a>

                                            </a>
                                        </li>
                                        <li><a href="/contacts"><i class="fa fa-envelope"></i> abalaba@gmail.com</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="social-icons pull-right">
                                    <ul class="nav navbar-nav">
                                        <li><a href="https://www.facebook.com/abalabacom/"><i class="fa fa-facebook"></i></a></li>
